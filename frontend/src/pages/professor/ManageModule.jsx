...
import { FaUpload, FaBook, FaUsers, FaDownload } from 'react-icons/fa';
...
const ManageModule = () => {
  ...
  const fetchModuleData = async () => {
    try {
      const modulesResponse = await professorService.getModules();
      const currentModule = modulesResponse.data.find(m => m._id === moduleId);
      setModule(currentModule);

      const studentsResponse = await professorService.getStudents(moduleId);
